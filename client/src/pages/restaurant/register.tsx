...
import { Eye, EyeOff, ArrowLeft, ChefHat, Mail, Lock, User, Phone, MapPin, FileText } from "lucide-react";
...
export default function RestaurantRegister() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      registerData.append('role', 'restaurant');
      registerData.append('restaurantName', formData.restaurantName);
      registerData.append('description', formData.description);
        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="text-center pb-8">
            ...
            <CardDescription className="text-gray-600 mt-2">
              Bergabung dengan TasFood dan jangkau lebih banyak pelanggan
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                {isLoading ? "Mendaftar..." : "Daftar Sebagai Mitra"}
              </Button>
            </form>

            <div className="bg-orange-50 p-4 rounded-lg">
              <h4 className="font-semibold text-orange-800 mb-2">Keuntungan Menjadi Mitra</h4>
              <ul className="text-sm text-orange-700 space-y-1">
                <li>• Jangkauan pelanggan lebih luas</li>
                <li>• Sistem manajemen pesanan otomatis</li>
                <li>• Komisi kompetitif</li>
                <li>• Marketing dan promosi gratis</li>
              </ul>
            </div>
